...
from apex_recoils.core import ReaSnowSelectGun, SelectGun
...
if __name__ == "__main__":
    ...
    SelectGun.select_gun = SelectGun.SelectGun(
        ...
        screen_taker=SocketScreenTaker(
            LogFactory.logger(), (global_config.distributed_param["ip"], global_config.distributed_param["port"])
        ),
    )
    ...
    listener = pynput.mouse.Listener(on_click=apex_mouse_listener.on_click)
    listener.start()
